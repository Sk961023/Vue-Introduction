...
export default {
  ...
  mounted() {
    var olderHeight = document.body.clientHeight;
    console.log(olderHeight);
    document.getElementById("order-list").style.height = olderHeight + "px";
  }
};
</script>
